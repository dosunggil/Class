...
public class Var_01 {
	 ...
	 * 
	 * 초기에 Java Project를 시작할 때는 
	 * 반드시 main() {} 블럭에서부터 코드가 시작되어야 한다.
	 */
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		
		// 숫자형 변수는 선언할 때 최소환 0으로 값을 할당하자
		 ...
		 * 			키워드1.키워드2.키워드3 처럼 Dot으로 키워드를 구분하여 명령문을 구현한다.
		 * 
		 ...
		 * 
		 * 
		 * Dot으로 조합된 키워드는 사용하는 경우의 수가 제한적이다.
		 * System.out.println()
		 * PrintWriter.println()
		...
		// method에 따라 args 가 있거나 없거나 상관없이 작동 되기도 하고
		//						 없으면 문법 오류를 발생하기도 한다.
